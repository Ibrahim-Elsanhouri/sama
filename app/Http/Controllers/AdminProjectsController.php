...
$columns[] = ['label'=>'اسم المرفق','name'=>'name','type'=>'text'];
$columns[] = ['label'=>'المرفق','name'=>'file','type'=>'upload'];
$this->form[] = ['label'=>'مرفقات المشروع','name'=>'attachments','type'=>'child','columns'=>$columns,'table'=>'attachments','foreign_key'=>'projects_id'];
