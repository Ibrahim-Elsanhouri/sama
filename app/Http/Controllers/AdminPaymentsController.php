<?php namespace App\Http\Controllers;
	...
	class AdminPaymentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"قيمة الدفعه","name"=>"amount"];
			$this->col[] = ["label"=>"البنك","name"=>"banks_id","join"=>"banks,name"];
	    ...
	    */
		...
		//	$data['row'] = DB::table('payments')->where('id',$id)->first();
			$payment = Payment::find($id);

			//Please use view method instead view method from laravel
			return view('payments.show', compact('data' , 'payment'));
		  }
