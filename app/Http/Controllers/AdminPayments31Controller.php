<?php namespace App\Http\Controllers;
	...
	class AdminPayments31Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Banks Id','name'=>'banks_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'banks,name'];
			...
			$this->form[] = ['label'=>'Ref','name'=>'ref','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Banks Id","name"=>"banks_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"banks,name"];
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Income','count'=>DB::table('payments')->sum('amount'),
